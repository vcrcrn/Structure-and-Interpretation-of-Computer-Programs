...
class Ant(Insect):
    ...
    def add_to(self, place):
        ...
        elif place.ant.can_contain(self) and place.ant.ant_contained is None and self.is_container == False:
            place.ant.ant_contained = self
            
        elif self.is_container and self.can_contain(place.ant) and place.ant.is_container == False:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while True:
            ...
            if curr_place.bees != [] and self.min_range <= range <= self.max_range:
                return random_bee(curr_place.bees)
           
            elif curr_place.entrance.is_hive:
                return None
...
class HungryAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        if self.chew_timer != 0:
            self.chew_timer -= 1
            if self.chew_timer == self.time_to_chew:
                self.chew_timer = 0
